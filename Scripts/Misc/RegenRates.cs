...
namespace Server.Misc
{
	public class RegenRates
	{
		...
		{
			Mobile.DefaultHitsRate = TimeSpan.FromSeconds(Settings.Get<double>("Gameplay", "HitsRegenRate"));
			Mobile.DefaultStamRate = TimeSpan.FromSeconds(Settings.Get<double>("Gameplay", "StamRegenRate"));
			Mobile.DefaultManaRate = TimeSpan.FromSeconds(Settings.Get<double>("Gameplay", "ManaRegenRate"));
